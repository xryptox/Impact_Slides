...
- Evidence is immutable; a correction is a new renderer-version directory. Live kernel paint after 3.0.0 may change HTML/`run_meta`/schema; notes/evidence stay pinned. 3.0.0 schema copies stay internally consistent and hash-pinned — do not re-pin them from later live schema. Live D314 corpus may advance after 3.0.0; do not rebuild this snapshot from later live input.
