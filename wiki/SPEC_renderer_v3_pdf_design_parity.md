...
| 5, 8, 9, 10 | side KPI / generation / segment supports | `metric_strip` / `support_table` | DOM: KPI values present |
| 8 | property/credit KPI stack | `metric_strip` | DOM: 3,400+ / $600 / $550 |
| 12 | 3-band NCA stack (UCS/Commercial/ICS ~3.x) | `stacked_bar` 3 series | chart dataset count = 3 |
| 15 | reserve-rate outlined row; stack totals | `outlined_support` + authored totals | DOM: 2.9%…2.8% row aligned |
