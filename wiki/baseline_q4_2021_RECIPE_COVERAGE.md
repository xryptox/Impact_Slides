...
| 28 | Delinquent and Financial Relief Program Balances | `single_chart` | `passes/pass_01/compare/sbs/slide_28.png` | accepted v3 design divergence | stacked_bar Delinquent/FRP/CPR including Apr'20 $8.5 plus two-row category-aligned Total Loans / CM Receivables support boxes ($1.9/$7.1/$3.0/$1.7/$1.6 and $0.9/$4.4/$1.0/$0.6/$0.6) with a frozen 8px row gap. Figures match. Boardroom isolated boxes vs PDF outlined boxes; not a navy IR grid. |
