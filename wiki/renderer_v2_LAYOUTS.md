...
| `chart_hero_dual` | `render_chart_hero_dual` | impact_slides/renderer_v2/layout/recipes/charts.py:518 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `combo_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:157 | `golden_mvp1_handoff.json` | `chart_polish.py`, `chart_styling.py`, `combo_chart.py` +5 |
...
| `dual_chart` | `render_dual_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:426 | — | `chart_typography_r6a.py`, `dual_chart.py`, `layout_dispatch_parity.py` +1 |
...
| `grouped_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:157 | `golden_mvp1_handoff.json`, `mini_handoff.json` | `bar_group_brackets.py`, `chart_polish.py`, `chart_styling.py` +12 |
...
| `heatmap` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:157 | — | `layout_dispatch_parity.py`, `renderer_v2_heatmap_waterfall.py`, `renderer_v2_validation.py` |
...
| `icon_grid` | `render_icon_grid` | impact_slides/renderer_v2/layout/recipes/charts.py:572 | `mini_handoff.json` | `existing_layout_refactor.py`, `layout_dispatch_parity.py`, `renderer_v2_gridlines.py` +3 |
...
| `line_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:157 | `golden_mvp1_handoff.json` | `chart_polish.py`, `chart_styling.py`, `chart_supporting_elements.py` +8 |
...
| `multi_panel` | `render_multi_panel` | impact_slides/renderer_v2/layout/recipes/charts.py:591 | — | `chart_typography_r6a.py`, `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `priority_matrix` | `render_priority_matrix` | impact_slides/renderer_v2/layout/recipes/charts.py:784 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
...
| `stacked_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:157 | — | `bar_group_brackets.py`, `chart_polish.py`, `chart_styling.py` +6 |
...
| `waterfall_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:157 | — | `layout_dispatch_parity.py`, `renderer_v2_heatmap_waterfall.py`, `renderer_v2_validation.py` |
