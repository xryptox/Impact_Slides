...
| `icon_grid` | `render_icon_grid` | impact_slides/renderer_v2/layout/recipes/charts.py:487 | `mini_handoff.json` | `existing_layout_refactor.py`, `layout_dispatch_parity.py`, `renderer_v2_gridlines.py` +3 |
...
| `multi_panel` | `render_multi_panel` | impact_slides/renderer_v2/layout/recipes/charts.py:506 | — | `chart_typography_r6a.py`, `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `priority_matrix` | `render_priority_matrix` | impact_slides/renderer_v2/layout/recipes/charts.py:699 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
