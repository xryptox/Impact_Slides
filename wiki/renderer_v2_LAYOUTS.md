...
|---|---|---|---|---|
| `annex_table` | `render_annex_table` | impact_slides/renderer_v2/layout/recipes/metrics.py:399 | `amex_annex_33_37_restored_handoff.json`, `amex_annex_33_37_v10_broken_handoff.json` | `amex_annex_33_37_handoff.py`, `grouped_annex_table.py`, `layout_dispatch_parity.py` +1 |
...
| `data_table` | `render_table` | impact_slides/renderer_v2/layout/recipes/metrics.py:64 | `amex_slide26_te_billed_business.json`, `mini_handoff.json` | `amex_slide26_matrix_orientation.py`, `chart_supporting_elements.py`, `chart_table_alignment.py` +10 |
| `data_table_with_insight` | `render_data_table_with_insight` | impact_slides/renderer_v2/layout/recipes/metrics.py:220 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1a_layouts.py` |
...
| `grouped_annex_table` | `render_grouped_annex_table` | impact_slides/renderer_v2/layout/recipes/metrics.py:368 | `amex_slide32_grouped_annex.json` | `layout_dispatch_parity.py` |
...
| `guidance_statement_card` | `render_guidance_statement_card` | impact_slides/renderer_v2/layout/recipes/metrics.py:517 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `ir_bullet_sheet` | `render_ir_bullet_sheet` | impact_slides/renderer_v2/layout/recipes/metrics.py:486 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
| `kpi_trend_cards` | `render_kpi_trend_cards` | impact_slides/renderer_v2/layout/recipes/metrics.py:435 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave3b_layouts.py` |
...
| `metric_dashboard` | `render_metric` | impact_slides/renderer_v2/layout/recipes/metrics.py:25 | `mini_handoff.json` | `existing_layout_refactor.py`, `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` +5 |
| `metric_row_with_breakdown` | `render_metric_row_with_breakdown` | impact_slides/renderer_v2/layout/recipes/metrics.py:138 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
