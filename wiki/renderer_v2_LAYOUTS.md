...
| `chart_hero_dual` | `render_chart_hero_dual` | impact_slides/renderer_v2/layout/recipes/charts.py:566 | `amex_v10_44_slide_handoff.json` | `chart_hero_dual_headings.py`, `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `combo_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | `amex_v10_44_slide_handoff.json`, `golden_mvp1_handoff.json` | `auto_chart_typography.py`, `chart_polish.py`, `chart_styling.py` +6 |
...
| `data_table` | `render_table` | impact_slides/renderer_v2/layout/recipes/metrics.py:67 | `amex_s24_v10_broken.json`, `amex_slide26_te_billed_business.json`, `amex_v10_44_slide_handoff.json` +1 | `amex_s24_growth_handoff_contract.py`, `amex_slide26_matrix_orientation.py`, `chart_supporting_elements.py` +11 |
...
| `dual_chart` | `render_dual_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:458 | `amex_s13_s14_corrected.json`, `amex_s13_s14_v10_broken.json`, `amex_s27_corrected.json` +2 | `auto_chart_typography.py`, `chart_typography_r6a.py`, `dual_chart.py` +2 |
...
| `grouped_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | `amex_s13_s14_corrected.json`, `amex_v10_44_slide_handoff.json`, `golden_mvp1_handoff.json` +1 | `amex_s24_growth_handoff_contract.py`, `auto_chart_typography.py`, `bar_group_brackets.py` +15 |
...
| `heatmap` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | — | `layout_dispatch_parity.py`, `renderer_v2_heatmap_waterfall.py`, `renderer_v2_validation.py` |
...
| `horizontal_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | `amex_v10_44_slide_handoff.json` | `auto_chart_typography.py`, `chart_polish.py`, `layout_dispatch_parity.py` +1 |
...
| `icon_grid` | `render_icon_grid` | impact_slides/renderer_v2/layout/recipes/charts.py:646 | `mini_handoff.json` | `existing_layout_refactor.py`, `layout_dispatch_parity.py`, `renderer_v2_gridlines.py` +3 |
...
| `line_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | `amex_s13_s14_v10_broken.json`, `amex_s27_corrected.json`, `amex_s27_v10_broken.json` +2 | `amex_s13_s14_handoff_contract.py`, `amex_s27_scenarios.py`, `auto_chart_typography.py` +11 |
...
| `multi_panel` | `render_multi_panel` | impact_slides/renderer_v2/layout/recipes/charts.py:665 | `amex_s28_corrected.json`, `amex_s28_v10_broken.json`, `amex_v10_44_slide_handoff.json` | `AGENTS.md`, `amex_s28_handoff_contract.py`, `chart_typography_r6a.py` +3 |
...
| `priority_matrix` | `render_priority_matrix` | impact_slides/renderer_v2/layout/recipes/charts.py:924 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
...
| `stacked_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | `amex_s28_corrected.json`, `amex_s28_v10_broken.json`, `amex_v10_44_slide_handoff.json` | `auto_chart_typography.py`, `bar_group_brackets.py`, `chart_polish.py` +7 |
...
| `waterfall_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | — | `auto_chart_typography.py`, `layout_dispatch_parity.py`, `renderer_v2_heatmap_waterfall.py` +1 |
