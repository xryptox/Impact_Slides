...
| `grouped_annex_table` | `render_grouped_annex_table` | impact_slides/renderer_v2/layout/recipes/metrics.py:326 | `amex_slide32_grouped_annex.json` | `layout_dispatch_parity.py` |
