...
| `chart_hero_dual` | `render_chart_hero_dual` | impact_slides/renderer_v2/layout/recipes/charts.py:404 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `combo_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:120 | `golden_mvp1_handoff.json` | `chart_polish.py`, `chart_styling.py`, `combo_chart.py` +5 |
...
| `dual_chart` | `render_dual_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:324 | — | `dual_chart.py`, `layout_dispatch_parity.py`, `renderer_v2_features.py` |
...
| `grouped_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:120 | `golden_mvp1_handoff.json`, `mini_handoff.json` | `bar_group_brackets.py`, `chart_polish.py`, `chart_styling.py` +11 |
...
| `heatmap` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:120 | — | `layout_dispatch_parity.py`, `renderer_v2_heatmap_waterfall.py`, `renderer_v2_validation.py` |
...
| `horizontal_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:120 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `icon_grid` | `render_icon_grid` | impact_slides/renderer_v2/layout/recipes/charts.py:447 | `mini_handoff.json` | `existing_layout_refactor.py`, `layout_dispatch_parity.py`, `renderer_v2_gridlines.py` +3 |
...
| `line_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:120 | `golden_mvp1_handoff.json` | `chart_polish.py`, `chart_styling.py`, `chart_supporting_elements.py` +7 |
...
| `multi_panel` | `render_multi_panel` | impact_slides/renderer_v2/layout/recipes/charts.py:466 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `priority_matrix` | `render_priority_matrix` | impact_slides/renderer_v2/layout/recipes/charts.py:652 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
...
| `stacked_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:120 | — | `bar_group_brackets.py`, `chart_polish.py`, `chart_styling.py` +5 |
...
| `waterfall_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:120 | — | `layout_dispatch_parity.py`, `renderer_v2_heatmap_waterfall.py`, `renderer_v2_validation.py` |
