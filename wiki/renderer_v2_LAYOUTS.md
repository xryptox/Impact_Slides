...
| `chart_hero_dual` | `render_chart_hero_dual` | impact_slides/renderer_v2/layout/recipes/charts.py:574 | `amex_v10_44_slide_handoff.json` | `chart_hero_dual_headings.py`, `driver_card.py`, `layout_dispatch_parity.py` +1 |
...
| `grouped_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:178 | `amex_s13_s14_corrected.json`, `amex_v10_44_slide_handoff.json`, `golden_mvp1_handoff.json` +1 | `amex_s24_growth_handoff_contract.py`, `auto_chart_typography.py`, `bar_group_brackets.py` +17 |
...
| `icon_grid` | `render_icon_grid` | impact_slides/renderer_v2/layout/recipes/charts.py:662 | `mini_handoff.json` | `existing_layout_refactor.py`, `layout_dispatch_parity.py`, `renderer_v2_gridlines.py` +3 |
...
| `multi_panel` | `render_multi_panel` | impact_slides/renderer_v2/layout/recipes/charts.py:681 | `amex_s28_corrected.json`, `amex_s28_v10_broken.json`, `amex_v10_44_slide_handoff.json` | `AGENTS.md`, `amex_s28_handoff_contract.py`, `chart_typography_r6a.py` +3 |
...
| `priority_matrix` | `render_priority_matrix` | impact_slides/renderer_v2/layout/recipes/charts.py:940 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
