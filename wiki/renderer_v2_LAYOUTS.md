...
|---|---|---|---|---|
| `annex_table` | `render_annex_table` | impact_slides/renderer_v2/layout/recipes/metrics.py:357 | `amex_annex_33_37_restored_handoff.json`, `amex_annex_33_37_v10_broken_handoff.json` | `amex_annex_33_37_handoff.py`, `grouped_annex_table.py`, `layout_dispatch_parity.py` +1 |
...
| `combo_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:169 | `golden_mvp1_handoff.json` | `chart_polish.py`, `chart_styling.py`, `combo_chart.py` +5 |
...
| `data_table` | `render_table` | impact_slides/renderer_v2/layout/recipes/metrics.py:63 | `amex_slide26_te_billed_business.json`, `mini_handoff.json` | `amex_slide26_matrix_orientation.py`, `chart_supporting_elements.py`, `chart_table_alignment.py` +10 |
| `data_table_with_insight` | `render_data_table_with_insight` | impact_slides/renderer_v2/layout/recipes/metrics.py:219 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1a_layouts.py` |
...
| `grouped_annex_table` | `render_grouped_annex_table` | impact_slides/renderer_v2/layout/recipes/metrics.py:325 | `amex_slide32_grouped_annex.json` | `grouped_annex_table.py`, `layout_dispatch_parity.py` |
...
| `guidance_statement_card` | `render_guidance_statement_card` | impact_slides/renderer_v2/layout/recipes/metrics.py:511 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `horizontal_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:169 | — | `chart_polish.py`, `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `ir_bullet_sheet` | `render_ir_bullet_sheet` | impact_slides/renderer_v2/layout/recipes/metrics.py:480 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
| `kpi_trend_cards` | `render_kpi_trend_cards` | impact_slides/renderer_v2/layout/recipes/metrics.py:429 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave3b_layouts.py` |
| `line_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:169 | `amex_s13_s14_v10_broken.json`, `amex_s27_corrected.json`, `amex_s27_v10_broken.json` +1 | `amex_s13_s14_handoff_contract.py`, `amex_s27_scenarios.py`, `chart_polish.py` +10 |
| `metric_dashboard` | `render_metric` | impact_slides/renderer_v2/layout/recipes/metrics.py:24 | `mini_handoff.json` | `existing_layout_refactor.py`, `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` +5 |
| `metric_row_with_breakdown` | `render_metric_row_with_breakdown` | impact_slides/renderer_v2/layout/recipes/metrics.py:137 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
...
| `stacked_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:169 | `amex_s28_corrected.json`, `amex_s28_v10_broken.json` | `bar_group_brackets.py`, `chart_polish.py`, `chart_styling.py` +6 |
