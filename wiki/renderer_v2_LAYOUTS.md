...
|---|---|---|---|---|
| `annex_table` | `render_annex_table` | impact_slides/renderer_v2/layout/recipes/metrics.py:417 | `amex_annex_33_37_restored_handoff.json`, `amex_annex_33_37_v10_broken_handoff.json` | `amex_annex_33_37_handoff.py`, `grouped_annex_table.py`, `layout_dispatch_parity.py` +1 |
...
| `chart_hero_dual` | `render_chart_hero_dual` | impact_slides/renderer_v2/layout/recipes/charts.py:532 | — | `chart_hero_dual_headings.py`, `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `combo_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | `golden_mvp1_handoff.json` | `chart_polish.py`, `chart_styling.py`, `combo_chart.py` +5 |
...
| `dual_chart` | `render_dual_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:449 | `amex_s13_s14_corrected.json`, `amex_s13_s14_v10_broken.json`, `amex_s27_corrected.json` +1 | `auto_chart_typography.py`, `chart_typography_r6a.py`, `dual_chart.py` +2 |
...
| `grouped_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | `amex_s13_s14_corrected.json`, `golden_mvp1_handoff.json`, `mini_handoff.json` | `amex_s24_growth_handoff_contract.py`, `auto_chart_typography.py`, `bar_group_brackets.py` +15 |
...
| `horizontal_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | — | `chart_polish.py`, `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `ir_bullet_sheet` | `render_ir_bullet_sheet` | impact_slides/renderer_v2/layout/recipes/metrics.py:504 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `line_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | `amex_s13_s14_v10_broken.json`, `amex_s27_corrected.json`, `amex_s27_v10_broken.json` +1 | `amex_s13_s14_handoff_contract.py`, `amex_s27_scenarios.py`, `auto_chart_typography.py` +11 |
...
| `metric_row_with_breakdown` | `render_metric_row_with_breakdown` | impact_slides/renderer_v2/layout/recipes/metrics.py:141 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
| `multi_panel` | `render_multi_panel` | impact_slides/renderer_v2/layout/recipes/charts.py:626 | `amex_s28_corrected.json`, `amex_s28_v10_broken.json` | `AGENTS.md`, `amex_s28_handoff_contract.py`, `chart_typography_r6a.py` +3 |
...
| `stacked_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | `amex_s28_corrected.json`, `amex_s28_v10_broken.json` | `bar_group_brackets.py`, `chart_polish.py`, `chart_styling.py` +6 |
...
| `waterfall_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:170 | — | `layout_dispatch_parity.py`, `renderer_v2_heatmap_waterfall.py`, `renderer_v2_validation.py` |
