...
| `chart_hero_dual` | `render_chart_hero_dual` | impact_slides/renderer_v2/layout/recipes/charts.py:532 | `amex_v10_44_slide_handoff.json` | `chart_hero_dual_headings.py`, `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `dual_chart` | `render_dual_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:449 | `amex_s13_s14_corrected.json`, `amex_s13_s14_v10_broken.json`, `amex_s27_corrected.json` +2 | `auto_chart_typography.py`, `chart_typography_r6a.py`, `dual_chart.py` +2 |
...
| `icon_grid` | `render_icon_grid` | impact_slides/renderer_v2/layout/recipes/charts.py:607 | `mini_handoff.json` | `existing_layout_refactor.py`, `layout_dispatch_parity.py`, `renderer_v2_gridlines.py` +3 |
...
| `metric_row_with_breakdown` | `render_metric_row_with_breakdown` | impact_slides/renderer_v2/layout/recipes/metrics.py:141 | `amex_v10_44_slide_handoff.json` | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
| `multi_panel` | `render_multi_panel` | impact_slides/renderer_v2/layout/recipes/charts.py:626 | `amex_s28_corrected.json`, `amex_s28_v10_broken.json`, `amex_v10_44_slide_handoff.json` | `AGENTS.md`, `amex_s28_handoff_contract.py`, `chart_typography_r6a.py` +3 |
...
| `priority_matrix` | `render_priority_matrix` | impact_slides/renderer_v2/layout/recipes/charts.py:830 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
