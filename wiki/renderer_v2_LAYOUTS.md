...
| `chart_hero_dual` | `render_chart_hero_dual` | impact_slides/renderer_v2/layout/recipes/charts.py:410 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `dual_chart` | `render_dual_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:325 | — | `dual_chart.py`, `layout_dispatch_parity.py`, `renderer_v2_features.py` |
...
| `grouped_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:121 | `golden_mvp1_handoff.json`, `mini_handoff.json` | `bar_group_brackets.py`, `chart_polish.py`, `chart_styling.py` +11 |
...
| `icon_grid` | `render_icon_grid` | impact_slides/renderer_v2/layout/recipes/charts.py:458 | `mini_handoff.json` | `existing_layout_refactor.py`, `layout_dispatch_parity.py`, `renderer_v2_gridlines.py` +3 |
...
| `line_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:121 | `golden_mvp1_handoff.json` | `chart_polish.py`, `chart_styling.py`, `chart_supporting_elements.py` +7 |
...
| `multi_panel` | `render_multi_panel` | impact_slides/renderer_v2/layout/recipes/charts.py:477 | — | `layout_dispatch_parity.py`, `renderer_v2_charts_js.py` |
...
| `priority_matrix` | `render_priority_matrix` | impact_slides/renderer_v2/layout/recipes/charts.py:665 | — | `layout_dispatch_parity.py`, `visual_regression_deck.py`, `wave1b_layouts.py` |
...
| `stacked_bar_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:121 | — | `bar_group_brackets.py`, `chart_polish.py`, `chart_styling.py` +5 |
