...
| `line_chart` | `render_chart` | impact_slides/renderer_v2/layout/recipes/charts.py:361 | `amex_s13_s14_v10_broken.json`, `amex_s27_corrected.json`, `amex_s27_v10_broken.json` +2 | `AGENTS.md`, `amex_s13_s14_handoff_contract.py`, `amex_s27_scenarios.py` +13 |
