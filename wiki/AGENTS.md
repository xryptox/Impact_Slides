...
- Layout-stress 14x10 observation: `baseline_layout_stress_14x10.md` (#354 wrap recapture hashes for s005/s016/s017/s020/s055/s056/s059; remaining overflow families unchanged)
- Operational learnings: `AGENT_LEARNINGS.md` (live document; updated after each wave; pointer in root `AGENTS.md`). Current-tense reflexes are synthesized into `.agents/skills/delegated-delivery/`; the log stays canonical.

## Local Contracts

- Live agent entry remains root `AGENTS.md`, `CONTEXT.md`, `docs/agents/`, `.agents/skills/delegated-delivery/`, and code under `impact_slides/`
