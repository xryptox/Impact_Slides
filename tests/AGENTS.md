...
- Renderer v3 kernel (#175/#197): `test_renderer_v3_kernel.py` + fixture `renderer_v3/minimal_cover_narrative_cover.json` (typed Deck validation, D252–D254 chart/charts/hero/support slots, leftover v2 aliases rejected, allowlisted repairs, schema drift, v2 isolation + mutation traps)
