...
- Renderer v3 canonical Amex corpus (#196 / D54/D126/D314 / #224): `test_renderer_v3_canonical_amex.py` + fixture `renderer_v3/canonical_amex_handoff_v1.json` (44-slide D314 compositions/sections/evidence; slide 6 ~6pp claim; slide 21 Capital Summary; no operational speaker notes; strict-clean Chart.js + SVG-only render; run_meta chart surfaces freeze ticks ≥20 / values ≥18; rebuild via `scripts/build_canonical_amex_v1.py`; locators pin the D315 PDF SHA-256)
- Renderer v3 3.0.0 release evidence (#198 / D315): `test_renderer_v3_release_evidence.py` + `artifacts/renderer_3_release/3.0.0/` (hash-pinned inputs, exact-five D250 roots, required gates, approved D55 divergences, no whole-slide scoring; verify via `scripts/renderer_3_release.py --verify`)
