...
- Amex #156 slide-27 handoff contract: `test_amex_s27_scenarios.py` + fixtures `amex_s27_v10_broken.json` / `amex_s27_corrected.json` (`apply_issue_156_slide27_scenarios`; 13 quarterly categories, all three scenarios, source headings/SAAR note + #146 paint-ready dual-canvas geometry; no renderer production change)
