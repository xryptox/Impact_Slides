...
- Renderer v3 canonical Amex corpus (#196 / D54/D126/D314): `test_renderer_v3_canonical_amex.py` + fixture `renderer_v3/canonical_amex_handoff_v1.json` (44-slide D314 compositions/sections/evidence; slide 6 ~6pp claim; slide 21 Capital Summary; no operational speaker notes; strict-clean Chart.js + SVG-only render; rebuild via `scripts/build_canonical_amex_v1.py`; locators pin the D315 PDF SHA-256)
