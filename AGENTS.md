...
- `impact_slides/renderer_v3/AGENTS.md` — schema-v1 canonical rendering kernel (typed validation, plan freeze, chart/table/card composition families, format registry, legacy→v1 migrator, generated JSON Schema, deterministic artifact publication)
