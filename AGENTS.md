...
- Follow `docs/agents/delegated-delivery.md` for the canonical scripted PEW → visible Herdr implementer + one-shot host watcher → no-mistakes → host verification → approval-gated cheap merger workflow; do not substitute manual tab launches.
