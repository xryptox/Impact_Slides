...
- `impact_slides/renderer_v3/AGENTS.md` — schema-v1 canonical rendering kernel (typed validation + plan freeze + table compositions/format registry + generated JSON Schema + deterministic artifact publication); full chart painting in later tickets
