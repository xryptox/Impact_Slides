...
- `impact_slides/renderer_v3/AGENTS.md` — schema-v1 canonical rendering kernel (typed validation + generated JSON Schema + deterministic artifact publication); full painting in later tickets
