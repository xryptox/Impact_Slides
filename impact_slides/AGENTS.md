...
- `renderer_v3/AGENTS.md` — schema-v1 canonical kernel (typed validation, repairs, deck-wide plan freeze, table compositions + format registry, line-chart tracer, native heatmaps, generated JSON Schema, deterministic five-artifact `render_deck` publication); remaining chart families arrive in later tickets
