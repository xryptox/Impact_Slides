...
- `renderer_v3/AGENTS.md` — schema-v1 canonical kernel (typed validation, repairs, deck-wide plan freeze, table compositions + format registry, generated JSON Schema, deterministic five-artifact `render_deck` publication); full chart painting arrives in later tickets
