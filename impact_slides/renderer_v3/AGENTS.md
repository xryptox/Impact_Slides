...
- Deck-wide adaptive measure/plan freeze (`plan.py`) for narrative prose, data tables, axis charts (incl. stacked bars) + chart support surfaces, heatmaps, linear/grouping + relationship/decision compositions (fixed D60 type), subtitles, takeaways, disclosures, source footers, and fixed chrome (D1–D4, D10/D47, D22–D25, D44, D59, D60, D68–D70)
