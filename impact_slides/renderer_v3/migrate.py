...
_LEGACY_ENTRIES: tuple[InventoryEntry, ...] = (
    ...
    _det("dual_chart", "dual_chart", "Exactly two ordered charts; optional shared independent support_table or metric_strip, or per-pane ChartSupportVisual, never both."),
    ...
    # strategy_board is kernel-native (#295); no v2 mapping — D313 stays 57.
