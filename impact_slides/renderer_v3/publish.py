...
".metric-overview-detail{margin-top:16px}",
            ...
            ".support-table.category-aligned .support-cat-cell{box-sizing:border-box;border:var(--border-width-hairline) solid var(--color-rule)}",
            ".support-table.category-aligned .support-cat-stub,.support-table.category-aligned .support-cat-stub.head{box-sizing:border-box;border:none;background:transparent}",
            ".support-table.category-aligned .support-cat-cell.head{background:var(--color-band);color:var(--color-band-ink);font-weight:var(--font-weight-emphasis)}",
