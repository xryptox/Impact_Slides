...
- Sibling `../renderer_v3/AGENTS.md` owns renderer 3.0/schema-v1 kernel (validation, generated schema, deterministic five-artifact publication); do not implement v3 contracts here.
