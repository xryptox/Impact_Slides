...
| Chart.js UMD | 4.4.8 | MIT (`libs/CHART_JS_LICENSE.md`) | https://www.chartjs.org/ · https://github.com/chartjs/Chart.js | jsDelivr `chart.js@4.4.8/dist/chart.umd.js` | `libs/chart.umd.min.js` (~202 KB); feature-gated `charts` |
