...
#   - gnhf on PATH (C:\Users\Ag1Le\AppData\Roaming\npm\gnhf.cmd)
#
# Run from the repo root in PowerShell:
#   pwsh scripts/run_amex_simulation.ps1
# or:
#   .\scripts\run_amex_simulation.ps1
$ErrorActionPreference = "Stop"

# Prompt is a single-quoted here-string => no variable interpolation.
$PROMPT = @'
