...
| Repository commit at render | `9c2acd1683ccc8fe047213f01f0726596d62c909` |
...
|----------|------:|---------|
| presentation.html | 846870 | `0ba4f04b1e2f3d055b2c5b5ac548c9daa27180e6d6405957934cee21d35c368f` |
| slide_notes.md | 3361 | `1e7f90090b726e5bf9cbbc081b9b557b5f7a04219b535fb087fac259a8984b41` |
| evidence_manifest.json | 25031 | `bf031e4bd453268afd42b3f5f5e48d5956dc69137ba48faee76b65e4960811d4` |
| run_meta.json | 213345 | `36ec307a2050ab88853f3619f426c11dccef9d093053a442a8656587013f5349` |
| handoff_schema_v1.json | 214229 | `cee2cb3c654562d841396554cff245650f5123205c01db5e4289dcd560e682b5` |
...
Counts: faithful 5; accepted Boardroom chrome 13; Type A 21; Type B 14; source/PDF artifact 0; capture failure 0.
...
| 3 | Total Network Volumes Growth | `data_table` | `passes/pass_01/compare/sbs/slide_03.png` | corpus/extraction residual (Type A) | PDF is an 8-quarter line (Billed Business / Processed / Total) plus a 3-row summary table. single_chart line + support_table can hold that composition. Quarterly plot points were not glyph-readable and were omitted; only the readable table was authored. |
| 4 | Billed Business (G&S vs T&E) | `data_table` | `passes/pass_01/compare/sbs/slide_04.png` | candidate renderer defect or capability gap (Type B) | PDF is FY stacked G&S/T&E bars + 8-quarter growth line + Q4 table (3 panes). dual_chart is exactly two charts and has no support_table. Least-lossy legal stand-in is data_table of the readable Q4/FY figures. Missing recipe: 3-pane chart+chart+table. |
| 5 | Goods & Services Billed Business (Online vs Offline) | `data_table` | `passes/pass_01/compare/sbs/slide_05.png` | corpus/extraction residual (Type A) | PDF is Online/Offline/Total G&S line plus Q4 table. single_chart line + support_table is legal. Quarterly points were not glyph-readable; table-only authored. |
| 6 | Global Consumer Billed Business | `dual_chart` | `passes/pass_01/compare/sbs/slide_06.png` | candidate renderer defect or capability gap (Type B) | PDF is stacked mix bars with dollar totals and vs-2019 callouts plus an 8-quarter 4-series line, each with an under-plot table. dual_chart has no per-pane support_table and no geometric vs-2019 callouts. Authored stacked_bar mix + grouped_bar of the Q4 cohort table. Missing recipe: dual chart + two support tables; unread line is a Type A secondary. |
| 7 | Global Commercial Billed Business | `dual_chart` | `passes/pass_01/compare/sbs/slide_07.png` | candidate renderer defect or capability gap (Type B) | Same 2-chart + 2-table ceiling as s6 (Commercial G&S/T&E stack + SME vs L&G line). Authored stacked_bar + grouped_bar Q4 snapshot. Missing recipe: dual chart with under-plot tables. |
| 8 | Billed Business T&E Growth | `data_table` | `passes/pass_01/compare/sbs/slide_08.png` | corpus/extraction residual (Type A) | PDF is T&E-by-customer 8-quarter line plus Q4 table. single_chart line + support_table is legal. Line points unread; table authored. |
| 9 | Billed Business Growth by Region | `dual_chart` | `passes/pass_01/compare/sbs/slide_09.png` | candidate renderer defect or capability gap (Type B) | PDF is two 8-quarter lines plus two Q4 tables. dual_chart can take the two lines but not the tables. Authored two grouped_bar Q4 snapshots. Missing recipe: dual chart + support tables; unread lines are Type A secondary. |
| 10 | Worldwide Total Loans and Card Member Receivables | `dual_chart` | `passes/pass_01/compare/sbs/slide_10.png` | corpus/extraction residual (Type A) | PDF is two Q3-Q4 grouped-bar panes with in-bar YoY boxes and year groups. dual_chart grouped_bar is the right recipe; boxed-label auxiliary_series and category_groups exist. Handoff authored dollar bars only (YoY boxes and year separators omitted). |
| 11 | Card Member Credit Metrics | `dual_chart` | `passes/pass_01/compare/sbs/slide_11.png` | corpus/extraction residual (Type A) | PDF is two bar panes with 30+ DPD strips plus a GCP write-off strip. dual_chart grouped_bar can hold the two main panes; 3+ canvas for the GCP strip is Type B secondary. Handoff used line marks and swapped loan write-off bars (2.5% to 0.6%) onto the receivables 30+ series — a re-author would restore the two bar panes. |
| 12 | Total Provision | `chart_hero_dual` | `passes/pass_01/compare/sbs/slide_12.png` | corpus/extraction residual (Type A) | PDF is signed stacked write-off/reserve bars with total labels plus an FY Better/(Worse) table. combo with bar_mode stacked + line, and hero for the FY table, is legal. Handoff used grouped combo, so negatives sit side-by-side instead of stacked. Hero KPIs match $2,127 / $4,022 / $6,149. |
| 13 | Total Reserves | `data_table` | `passes/pass_01/compare/sbs/slide_13.png` | corpus/extraction residual (Type A) | PDF is a reserve walk (beginning, builds, releases, endings) with percent boxes. waterfall (and stacked_bar) exist. Handoff authored a 4-row ending snapshot table and dropped the $1.5 / $5.8 / ($2.2) flow columns. |
...
| 15 | Discount Revenue | `single_chart` | `passes/pass_01/compare/sbs/slide_15.png` | corpus/extraction residual (Type A) | PDF is Q3-Q4 bars with in-bar YoY boxes, average-rate boxes, and an FY inset. combo + boxed-label auxiliary + support_table/metric_strip are legal. Handoff plotted $B bars + rate as a line and omitted YoY boxes and the FY $25.7 inset. |
| 16 | Net Card Fees | `single_chart` | `passes/pass_01/compare/sbs/slide_16.png` | corpus/extraction residual (Type A) | PDF is 12 quarterly NCF bars with in-bar YoY and an FY inset ($5.2, 10%, 28%). combo bar+YoY line is a fair stand-in for the boxes; support_table would hold the FY inset and was not authored. |
| 17 | Net Interest Income | `single_chart` | `passes/pass_01/compare/sbs/slide_17.png` | corpus/extraction residual (Type A) | Same Q3-Q4 bar + YoY-box + yield-box pattern as s15. combo plots $B + yield line; in-bar YoY and FY $7.8 inset were not authored (boxed labels / support_table / metric_strip). |
...
| 20 | Marketing Investments and New Cards Acquired | `dual_chart` | `passes/pass_01/compare/sbs/slide_20.png` | corpus/extraction residual (Type A) | dual_chart grouped_bar is the right two-pane recipe (Marketing $B, Proprietary NCA). NCA bars match 1.4 to 2.7. Marketing Value Injection hatch split was not extracted as a second series; stacked_bar would hold it if the hatch amounts were readable. |
| 21 | Capital | `chart_hero_dual` | `passes/pass_01/compare/sbs/slide_21.png` | candidate renderer defect or capability gap (Type B) | PDF is CET1 bars + Capital Return bars + dividend strip (3 surfaces). chart_hero_dual is one chart + hero KPIs, so CET1 becomes 10.5% text. dual_chart would drop the dividend row. Missing recipe: two charts + metric strip. Capital Return $6.0/$2.3/$9.0 match. |
| 22 | The Growth Plan | `metric_overview` | `passes/pass_01/compare/sbs/slide_22.png` | corpus/extraction residual (Type A) | PDF is three equal cards (2022 Guidance / 2023 Expectations / 2024+ Aspiration) plus two qualifier bars. feature_cards (2-6) is the closer legal recipe. metric_overview flattened 2022-2024 into one KPI row and mixed years. |
...
| 25 | Global Consumer G&S Growth | `grouped_annex_table` | `passes/pass_01/compare/sbs/slide_25.png` | candidate renderer defect or capability gap (Type B) | PDF is an 8-quarter Online/Offline/G&S line plus two Q4 tables. grouped_annex_table holds the two tables. single_chart cannot also carry two annex matrices. Missing recipe: chart + grouped_annex. Unread line is Type A secondary. |
| 26 | Travel & Entertainment Billed Business | `data_table` | `passes/pass_01/compare/sbs/slide_26.png` | corpus/extraction residual (Type A) | PDF is T&E-by-industry 8-quarter line plus Q4 table. single_chart line + support_table is legal. Points unread; table authored (Restaurants/Lodging/Airlines/Other/Total match). |
| 27 | Worldwide Total Loans and Card Member Receivables Mix | `dual_chart` | `passes/pass_01/compare/sbs/slide_27.png` | candidate renderer defect or capability gap (Type B) | PDF is two mix donuts (Loan 68/12/20; Receivables 28/14/24/34). Closed chart set has no pie/donut. stacked_bar dual_chart is the least-lossy legal stand-in; mix percent match, radial geometry does not. |
| 28 | Delinquent and Financial Relief Program Balances | `single_chart` | `passes/pass_01/compare/sbs/slide_28.png` | corpus/extraction residual (Type A) | stacked_bar holds Delinquent / FRP / CPR stacks including Apr'20 $8.5 CPR. metric_strip would hold the below-plot Total Loans / CM Receivables boxes and was not authored. |
| 29 | Global Corporate Payments Card Member Credit Metrics | `single_chart` | `passes/pass_01/compare/sbs/slide_29.png` | corpus/extraction residual (Type A) | PDF is GCP write-off bars plus a Q2'21 bankruptcy side table. grouped_bar + support_table is legal. Handoff used a line and put the side table only in disclosure. |
| 30 | Credit Reserve Build Macroeconomic Assumptions | `narrative` | `passes/pass_01/compare/sbs/slide_30.png` | corpus/extraction residual (Type A) | PDF is two 4-series macro line charts (unemployment, GDP). dual_chart line is legal. Quarterly scenario points were not glyph-readable; authored narrative with an explicit extraction residual. No invented series. |
| 31 | Funding Mix | `single_chart` | `passes/pass_01/compare/sbs/slide_31.png` | corpus/extraction residual (Type A) | stacked_bar of Unsecured Term / Card ABS / Deposits / Short-term is the right recipe and mix percent match. Authored stack totals $126/$138/$132 follow extraction reading order; PDF visual is $138/$132/$126 on Q4'19/Q4'20/Q4'21. Re-author the auxiliary totals. |
| 32 | FX Impact on Network Volumes and Revenue Growth | `data_table` | `passes/pass_01/compare/sbs/slide_32.png` | candidate renderer defect or capability gap (Type B) | PDF is two 4-quarter Reported vs FX-Adj lines plus a 6-currency table. dual_chart can take the lines but not the table. Unread plot points (Type A secondary). Currency table authored. Missing recipe: dual chart + support table. |
...
| 36 | 2021 ESG Highlights | `narrative` | `passes/pass_01/compare/sbs/slide_36.png` | corpus/extraction residual (Type A) | narrative can hold the full nested DE&I / Financial Confidence / Climate bullets. Handoff condensed to three summary bullets (Type A authoring miss), not a recipe ceiling. |
| 37 | Annex 1 Network Volumes – Reported & FX-Adjusted | `annex_table` | `passes/pass_01/compare/sbs/slide_37.png` | candidate renderer defect or capability gap (Type B) | PDF Annex 1 is an 18-period reported/FX matrix. annex_table cannot present that IR history at 1920x1080 (fit/column ceiling). Authored a 4-column Q4/FY vs-2019 subset. Missing recipe: wide multi-year annex matrix. |
| 38 | Annex 1 Network Volumes – Reported & FX-Adjusted | `annex_table` | `passes/pass_01/compare/sbs/slide_38.png` | candidate renderer defect or capability gap (Type B) | Annex 1 (2 of 2) is the same wide matrix for L&G / Int'l SME / SME. 4-column subset only. Same Type B ceiling as s37. |
| 39 | Annex 2 Discount Revenue – Reported & FX-Adjusted | `annex_table` | `passes/pass_01/compare/sbs/slide_39.png` | corpus/extraction residual (Type A) | Annex 2 PDF is 12 period columns of GAAP/FX discount revenue. Schema allows up to the table column budget; handoff authored only Q3'21/Q4'21/FY'21. Re-author a wider annex_table before calling this a fit ceiling. |
| 40 | Annex 3 Net Card Fees – Reported & FX-Adjusted | `annex_table` | `passes/pass_01/compare/sbs/slide_40.png` | candidate renderer defect or capability gap (Type B) | Annex 3 PDF is a 19-period NCF history. Same wide-matrix ceiling as Annex 1. Authored Q4'21/FY'21 only. |
| 41 | Annex 4 Net Interest Income – Reported & FX-Adjusted | `annex_table` | `passes/pass_01/compare/sbs/slide_41.png` | corpus/extraction residual (Type A) | Annex 4 PDF is 12 period columns. Authored Q3'21/Q4'21/FY'21 only; wider annex_table not yet tried. |
...
| 43 | Annex 6 Revenues Net of Interest Expense | `annex_table` | `passes/pass_01/compare/sbs/slide_43.png` | candidate renderer defect or capability gap (Type B) | Annex 6 (1 of 2) is a 19-period revenue history. Authored Q4'21/FY'21 only. Wide-matrix ceiling. |
| 44 | Annex 6 Revenues Net of Interest Expense | `annex_table` | `passes/pass_01/compare/sbs/slide_44.png` | corpus/extraction residual (Type A) | Annex 6 (2 of 2) is 10 period columns (2019 + 2021). Authored the five 2021 columns and dropped the 2019 block; 10 columns are within budget. |
...
s33, s34, s42, s45, s46, s01, s02, s14, s18, s19, s23, s47, s48, s49, s50, s51, s52, s53 — 18 slides.
...
s03, s05, s08, s10, s11, s12, s13, s15, s16, s17, s20, s22, s26, s28, s29, s30, s31, s36, s39, s41, s44 — 21 slides.
...
s04, s06, s07, s09, s21, s24, s25, s27, s32, s35, s37, s38, s40, s43 — 14 slides.
...
- s11: line + line
- s12: combo (grouped) + hero
- s15: combo
- s16: combo
- s17: combo
- s18: line
- s20: grouped_bar + grouped_bar
- s21: grouped_bar + hero
- s27: stacked_bar + stacked_bar (donut stand-in)
- s28: stacked_bar
- s29: line
- s31: stacked_bar
