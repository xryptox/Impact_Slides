"""Playwright geometry probes for Amex Q1'26 simulation (v9).
...
def main() -> int:
    ...
    with sync_playwright() as p:
        ...
        # v9 levers (separate module keeps this file diff small)
        from v9_levers import probe_measure_rule, probe_outlined_boxes, probe_funding_packing
        r, o = probe_measure_rule(page, 16)
        all_rows.extend(r)
        observations["measure16"] = o
        r, o = probe_outlined_boxes(page, 14)
        all_rows.extend(r)
        observations["outlined14"] = o
        r, o = probe_funding_packing(page, 27)
        all_rows.extend(r)
        observations["packing27"] = o
