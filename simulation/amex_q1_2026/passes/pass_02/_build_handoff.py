"""Author pass_02 handoff — close type-(A) gaps only (no renderer edits).

Changes vs pass_01 (handoff tuning):
...
def main():
    ...
    add(
        {
            ...
            "speaker_notes": "A: axis domain 0–15, series names/colors, annotation text; point-% labels still B.",
        }
    )
    ...
    add(
        {
            ...
            "speaker_notes": "Full expense grid from PDF page 19 text.",
        }
    )
    ...
    handoff = {
        "presentation": {
            ...
            "subtitle": "Simulation handoff · pass_02 · renderer_v2 capability probe",
            "audience": "Investors / IR",
            "primary_goal": (
                "Close type-(A) handoff gaps after pass_01; document remaining (B) capability gaps"
            ),
            "readiness_score": 60,
            "quality_flags": ["simulation", "amex_q1_2026", "pass_02"],
            "theme": THEME,
        },
        "slides": slides,
    }
